	...
	<header id="head">
		<div class="container">
             <div class="heading-text">							
							<h1 class="animated flipInY delay1" style="color: black;">Start Developing Today</h1>
							<p>Convert real world into programming world by your hands.</p>
						</div>
    ...
    <div class="row">
					<div class="col-md-4">
						<div class="grey-box-icon">
							...
							<p>This Article explains the details like Course fee structure, Duration of the course, Java Certificate holder jobs and salaries. Java is an object-oriented language that enables learners to create real-world applications. 
							</p>
     						<p><a href="${contextRoot}/courses"><em>Read More</em></a></p>
						</div><!--grey box -->
					</div><!--/span3-->
				<%-- 	<div class="col-md-3">
						<div class="grey-box-icon">
					...
					<div class="col-md-4">
						<div class="grey-box-icon">
							...
							<h4>Placements</h4>
							<p>We are here to provide the best to IT industry, we guide you in all the perspective and we teach you how to crack the interview's in easy manner,we try our best to place you in best company in industry</p>
     						<p><a href="${contextRoot}/courses"><em>Read More</em></a></p>
						</div><!--grey box -->
					</div><!--/span3-->
				</div>
      ...
      <section class="news-box top-margin">
        <div class="container">
            <h2><span>UPCOMING BATCHES</span></h2>
            <div class="row">
       
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure><a href="${contextRoot}/batches"><img src="${images}/java_training.jpg" alt=""></a></figure>
                            <div class="caption maxheight2">
                            <div class="box_inner">
                                        <div class="box">
                                            <p class="title"><a href="${contextRoot}/batches"><h5>Developement</h5></a></p>
                                            <p>Start learning the world's best programing language in fews days with joining us.</p>
                                        </div> 
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure><img src="${images}/coming_soon.jpg" alt=""></figure>
                            <div class="caption maxheight2">
                            <div class="box_inner">
                                        <div class="box">
                                            <p class="title"><h5>Testing   </h5></p>
                                            <p>Comming soon..</p>
                                        </div> 
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="newsBox">
                        <div class="thumbnail">
                           ...
                           <div class="box_inner">
                                        <div class="box">
                                            <p class="title"><h5>Nerworking</h5></p>
                                            <p>Comming soon..</p>
                                        </div> 
                                </div>
                            </div>
